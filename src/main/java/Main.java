...
public class Main {
    private static String filePath = "E:/Work/reportTask/src/resources/source-data.csv";
    private static String fileReport = "E:/Work/reportTask/src/resources/report.txt";
